...
Here is a while loop simulator. \url{https://lpatacch.github.io/thinkCPPGamesEx/WhilePractice.html}. With this, you can change the 
initial value, the condition it is checking (<, >, ==, !=, >=, <=), the value checked,
