...
Member functions differ from the other functions we have written
in two ways:
...
value. This works the same way as the function prototype that we saw in Section \ref{function_proto}.
